...
namespace BulkUploader.Models
{
    public class DataStringGp
    {
        ...
        public static string BulkOperationDB_WirelessActivityReport(DataTable dt, string repTime, DataTable header)
        {
            try
            {
                if (dt.Rows.Count == 0) return "No data to upload";
        ...
        public static string InsertHRStatus(string UserId, string EmpID, string Month, string Year)
        {
            try
            {
                string Evl = "";
        ...
        public static string InsertWirelessActivityStatus(string UserId, string EmpID, string Month, string Year)
        {
            try
            {
        ...
        public static string CommissionUpdateSTP(string date)
        {
            try
            {
                ...
                objDal.ProcName = "update_insert_ComissionSource";
                DAL.SPParameters spParam = new DAL.SPParameters();
                spParam.SetParam("@InputDate", SqlDbType.VarChar, date);
                status = objDal.AddData(spParam);
        ...
        public static string QuantumUpdateSTP(string date)
        {
            try
            {
                string status = "";
                DAL.DAL objDal = new DAL.DAL();
                objDal.ProcName = "UpdateFct_My_MTD_QuantumFiber";
                DAL.SPParameters spParam = new DAL.SPParameters();
                spParam.SetParam("@InputDate", SqlDbType.VarChar, date);
                status = objDal.AddData(spParam);
                return status == "Operation was successful" ? "1" : status;
